...
class OMDeBloomingDeviceExample
{

public:
	explicit OMDeBloomingDeviceExample(std::string config_path);
	virtual ~OMDeBloomingDeviceExample();
...
private:
	...
	uint32_t findTypeIndex(invz::GrabType type);
